    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=2, default=10000000, max_digits=15)),
                ('profit', models.IntegerField(default=0)),
                ('liked_stocks', models.ManyToManyField(blank=True, related_name='liked_by_users', to='stock.stock')),
